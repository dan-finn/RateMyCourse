...
class yourReviewsViewController: UIViewController, UICollectionViewDataSource {
    ...
    func getResults(){
        ...
        DispatchQueue.global(qos: DispatchQoS.QoSClass.userInitiated).async{
            guard let curUser = self.dbAccessor.getUser(Username: UserDefaults.standard.string(forKey: "rmcUsername")!) else {return}
            
            if let fetchedResults = self.dbAccessor.scanReviewsForUser(user: curUser){
